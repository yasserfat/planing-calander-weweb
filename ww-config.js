export default {
    editor: {
        ...
        customStylePropertiesOrder: [
            ...
            },
            {
                label: "Time grid",
                isCollapsible: true,
                properties: ['timeGridBackgroundColor', 'slotHeight', 'slotDuration'],
            },
            {
                label: "Buttons",
                isCollapsible: true,
    ...
    properties: {
        ...
        slotHeight: {
            label: { en: 'Slot height' },
            type: 'Length',
            section: 'style',
            bindable: true,
            defaultValue: '24px',
            options: {
                unitChoices: [{ value: 'px', label: 'px', min: 10, max: 200 }],
            },
            /* wwEditor:start */
            bindingValidation: {
                type: 'string',
                tooltip: 'Bind to a string value for the slot height (e.g., "40px")',
            },
            /* wwEditor:end */
        },
        slotDuration: {
            label: { en: 'Slot duration' },
            type: 'TextSelect',
            section: 'style',
            bindable: true,
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'Bind to a string value for the slot duration (e.g., "00:30:00")',
            },
            /* wwEditor:end */
        },
        showHeader: {
